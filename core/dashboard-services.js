    ...
    const result = rows.map((row) => {
      ...
      return {
        ...
        summary: row.type === 'friend-location' ? '位置变化'
          ...
          : row.type === 'hide-notification' ? ('通知已隐藏' + ((notificationTypeLabel(src) || notificationTypeLabel(content)) ? '：' + (notificationTypeLabel(src) || notificationTypeLabel(content)) : ''))
          : row.type === 'see-notification' ? ('通知已读' + ((notificationTypeLabel(src) || notificationTypeLabel(content)) ? '：' + (notificationTypeLabel(src) || notificationTypeLabel(content)) : ''))
